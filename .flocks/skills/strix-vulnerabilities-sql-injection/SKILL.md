---
name: strix-vulnerabilities-sql-injection
description: SQL injection testing covering union, blind, error-based, and ORM bypass techniques
---
> Vendored from `usestrix/strix@7e02b8d8dad4c238c17a815b94c5f7ed1e630172` (`strix/skills/vulnerabilities/sql_injection.md`), Apache-2.0.
