---
name: strix-vulnerabilities-mass-assignment
description: Mass assignment testing for unauthorized field binding and privilege escalation via API parameters
---
> Vendored from `usestrix/strix@7e02b8d8dad4c238c17a815b94c5f7ed1e630172` (`strix/skills/vulnerabilities/mass_assignment.md`), Apache-2.0.
