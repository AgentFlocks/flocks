...
---
> Vendored from `usestrix/strix@7e02b8d8dad4c238c17a815b94c5f7ed1e630172` (`strix/skills/frameworks/django.md`), Apache-2.0.
...
Use black-box HTTP tooling, browser flows, Caido history, and role-separated test accounts. Do not inspect application source.
