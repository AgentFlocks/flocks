---
name: strix-vulnerabilities-path-traversal-lfi-rfi
description: Path traversal and file inclusion testing for local/remote file access and code execution
---
> Vendored from `usestrix/strix@7e02b8d8dad4c238c17a815b94c5f7ed1e630172` (`strix/skills/vulnerabilities/path_traversal_lfi_rfi.md`), Apache-2.0.
