...
not request fixed-side information, override the trusted runner image/binary/argv/
mount, alter the canonical source snapshot, or claim that unverified evidence is a reproduced crash.
