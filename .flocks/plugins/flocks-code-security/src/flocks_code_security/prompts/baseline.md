...
5. Submit a candidate only when you can provide a plausible attack path and at least one exact evidence reference containing `relative_path`, `blob_digest`, `start_line`, and `end_line`.
