...
description: Deploy and manage network honeypots using OpenDecoy, T-Pot, or Cowrie to detect unauthorized access, lateral
...
- Python 3.8+ with pip for OpenDecoy installation
...
2. **Install Honeypot**: Deploy OpenDecoy, Cowrie, or T-Pot on dedicated host.
...
5. **Deploy Decoy Tokens**: Place credential files, shares, and DNS entries.
...
| Concept | Description |
|---------|-------------|
| OpenDecoy | Lightweight Python honeypot with modular service emulation |
...
| Decoy Token | Tripwire credential or file that alerts when accessed |
...
| Tool | Purpose |
|------|---------|
| OpenDecoy | Modular honeypot daemon with service emulation |
