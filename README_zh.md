...
- 🧬 **可插拔自我进化** — 可选的 4 层进化栈：能力获取 / 技能沉淀 / 使用追踪 / 后台 curator。Agent 可将成功经验沉淀为可复用 SKILL.md，curator 定期归档/合并陈旧技能。详见 [`flocks/evolution/README.md`](flocks/evolution/README.md)。默认关闭，老用户升级零行为变化。
