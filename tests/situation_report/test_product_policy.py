...
def test_policy_executes_only_matching_generate_modify_and_regenerate_actions():
    ...
    assert decide_report_prompt(_parts("请重新生成当前报告", "regenerate"), session_id="ses_current").kind == "execute"
    assert decide_report_prompt(_parts("请重新生成当前报告", "modify"), session_id="ses_current").kind == "direct"
