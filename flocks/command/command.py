...
class Command:
    ...
    def _ensure_defaults(cls) -> None:
        ...
        builtins = [
            ...
            CommandDef(
                name="dream",
                description="Run Memory evolution for the current project",
                template="Run Memory evolution for the current project.",
                execution_kind="direct",
                allow_attachments=False,
                visible_surfaces=ALL_SURFACES,
                requires_existing_session=True,
            ...
            CommandDef(
                name="learn",
                description="Learn a reusable Skill from the latest successful Turn",
                template="Learn a reusable Skill from the latest successful Turn.",
                execution_kind="direct",
                allow_attachments=False,
                visible_surfaces=ALL_SURFACES,
                requires_existing_session=True,
