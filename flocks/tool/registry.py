...
class ToolRegistry:
    ...
    def _register_builtin_tools(cls) -> None:
        ...
        _tool_groups = [
            ...
            # system/ — questions, Mission records, model/MCP/session management
            ("flocks.tool.system", ["question", "plan_exit", "mission_record", "model_config", "flocks_mcp", "session_manage", "slash_command", "tool_search"]),
