...
@ToolRegistry.register_function(
    ...
    description=(
        ...
        "Use this for WeCom, Weixin/WeChat, Feishu, DingTalk, or custom channel sessions when the user asks to send an IM message. "
    ...
    parameters=[
        ...
        ToolParameter(
            ...
            required=False,
            description=(
                "Optional channel filter, such as feishu, wecom, weixin/wechat, "
                "dingtalk, telegram, or a custom channel id."
            ),
        ),
        ToolParameter(
            name="target",
