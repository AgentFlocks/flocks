...
- examples should be of the form:
  - <example>
      ...
      <commentary>
      Since the user is greeting, use delegate_task to launch the greeting-responder agent to respond with a friendly joke.
      </commentary>
  ...
  - <example>
      ...
      user: "Hello"
      assistant: "I'm going to use delegate_task to launch the greeting-responder agent to respond with a friendly joke"
      <commentary>
      Since the user is greeting, use the greeting-responder agent to respond with a friendly joke. 
      </commentary>
    </example>
- If the user mentioned or implied that the agent should be used proactively, you should include examples of this.
- NOTE: Ensure that in the examples, you are making the assistant use delegate_task and not simply respond directly to the task.
